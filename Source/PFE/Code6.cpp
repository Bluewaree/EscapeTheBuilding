...
ACode6::ACode6()
{
	...
	TCode->OnComponentBeginOverlap.AddDynamic(this, &ACode6::TriggerEnter);
	TCode->OnComponentEndOverlap.AddDynamic(this, &ACode6::TriggerExit);
	RootComponent = TCode;
...
void ACode6::BeginPlay()
{
	Super::BeginPlay();

}

void ACode6::GetPlayer(AActor * Player)
{
...
// Called every frame
void ACode6::Tick(float DeltaTime)
{
...
void ACode6::TriggerEnter(class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
...
void ACode6::TriggerExit(class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
	if (OtherActor->IsA(ACharacter::StaticClass()))
	{
