...
ADoor1::ADoor1()
{
	...
	Door->OnComponentBeginOverlap.AddDynamic(this, &ADoor1::TriggerEnter);
	RootComponent = Door;
...
void ADoor1::TriggerEnter(class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
{
